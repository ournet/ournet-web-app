...
export default class IndexPage extends React.Component<IndexViewModel> {
    render() {
        const { lang, head, translate, links } = this.props;
                ...
                <main>
                    <div className='o-layout'>
                        <div className='o-layout__item u-2/4@tablet'>
                            {/* <EventListItem root={this.props} item={mainEvent} view='card-wide' imageSize='large' /> */}
                        </div>
                        <div className='o-layout__item u-2/4@tablet'>
                            <div className='o-layout'>
                                {/* {restEvents.slice(0, 2).map(item => <div key={item.id} className='o-layout__item u-1/2@mobile'><EventListItem root={this.props} item={item} view='card' /></div>)} */}
                            </div>
                        </div>
                    </div>
                    <div className='o-layout'>
                        ...
                        {/* {restEvents.slice(3, 5).map(item => <div key={item.id} className='o-layout__item u-1/4@tablet u-1/2@mobile'><EventListItem root={this.props} item={item} view='card' /></div>)} */}
