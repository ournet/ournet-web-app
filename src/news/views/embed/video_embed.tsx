  ...
  render() {
    ...
    if (!video) {
      ...
      if (video.sourceType === "IFRAME") {
        content = (
          <iframe
            className="c-embed-video_object"
            src={video.sourceId}
            frameBorder="0"
        ...
        content = (
          <iframe
            className="c-embed-video_object"
            src={`https://www.youtube.com/embed/${video.sourceId}?autoplay=1&rel=0`}
            frameBorder="0"
            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen={true}
          ></iframe>
        ...
        content = (
          <iframe
            className="c-embed-video_object"
            src={`https://player.vimeo.com/video/${video.sourceId}?autoplay=1`}
            frameBorder="0"
            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen={true}
          ></iframe>
      ...
      <html lang={lang}>
        <head>
          ...
          <link
            ...
            type="text/css"
            rel="stylesheet"
            href={getAssetUrl(project, "css", "video-embed", env.isProduction)}
          />
          <link rel="dns-prefetch" href="//assets.ournetcdn.net" />
          <script
            dangerouslySetInnerHTML={{
              __html: `window.CONSTANTS={lang:"${lang}",country:"${country}"};`
            }}
          ></script>
        </head>
...
ga('send', 'pageview');`
          ...
          ></script>
          <div className="c-embed-video">{content}</div>
        </body>
      </html>
    );
  }
