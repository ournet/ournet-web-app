...
export function SignPage(props: SignViewModel) {
    ...
    return (
        <CommonLayout {...props}>
            ...
            {config.oneSignal &&
                <div>
                    <div className='c-subscribe-bar u-hidden js-subscribe-box' data-category='notifications-horo' data-tags={JSON.stringify({ 'zodiac-sign': report.sign })} data-type='force'></div>
