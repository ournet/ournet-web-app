...
export abstract class PageViewModelBuilder<
  DATA extends OurnetAppData,
  CONFIG extends OurnetAppConfig,
  T extends PageViewModel<CONFIG>,
...
> extends AsyncViewModelBuilder<DATA, CONFIG, T, I> {
  ...
  protected setCanonical(link: string) {
    ...
    this.model.head.canonical =
      getSchema(project, country) + "//" + getHost(project, country) + link;
  }
}

export interface PageViewModel<CONFIG extends OurnetAppConfig>
  extends OurnetViewModel<CONFIG> {
