...
cacheOptions[OurnetQueryMethods.news_eventsLatestByTopic] = {
  max: 150,
  ttl: ms("10m")
};
cacheOptions[OurnetQueryMethods.weather_nowPlaceForecast] = {
  max: 50,
  ttl: ms("30m")
};
cacheOptions[OurnetQueryMethods.weather_datePlacesForecast] = {
  max: 100,
  ttl: ms("1h")
};
cacheOptions[OurnetQueryMethods.places_placeById] = {
  max: 500,
  ttl: ms("30m")
};
cacheOptions[OurnetQueryMethods.places_mainPlaces] = { max: 50, ttl: ms("2h") };
cacheOptions[OurnetQueryMethods.places_placesByIds] = {
  max: 100,
  ttl: ms("1h")
};
cacheOptions[OurnetQueryMethods.quotes_latest] = { max: 20, ttl: ms("10m") };
cacheOptions[OurnetQueryMethods.topics_topicsByIds] = {
  max: 50,
  ttl: ms("1h")
};
