...
export class OurnetViewModelBuilder<
  DATA extends OurnetAppData,
  CONFIG extends OurnetAppConfig,
  T extends OurnetViewModel<CONFIG>,
...
> extends ViewModelBuilder<T, I> {
  ...
  constructor(input: I, data: DATA) {
    ...
    model.containsProject = (project: OurnetProjectName) =>
      model.config.projects.includes(project);
  }
...
export function getLanguageFromQueryString(
