    ...
    switch (place.countryCode) {
      ...
      case "md":
        return name
          ...
          .replace("Municipiu ", "")
          .replace("Unitate Teritorială Autonomă Găgăuzia", "Gagauzia")
          .replace("Unitate Teritoriala Autonoma Gagauzia", "Găgăuzia");
      case "ru":
        return name.replace("Республика ", "");
      case "in":
        return name
          .replace("National Capital Territory of ", "")
      ...
      case "es":
        return name
          .replace("Comunidad Autónoma de ", "")
          .replace("Región de ", "")
          .replace("Región de ", "Principado de ")
