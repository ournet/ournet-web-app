...
export class Widget2ViewModelBuilder extends PageViewModelBuilder<
  WeatherAppData,
  WeatherAppConfig,
  Widget2ViewModel,
...
> {
  ...
  static createWidgetInfo(input: Widget2ViewModelInput) {
    ...
    let textColor = color
      .darken(22 / LAB_CONSTANTS)
      .brighten(90 / LAB_CONSTANTS)
      .hex();
