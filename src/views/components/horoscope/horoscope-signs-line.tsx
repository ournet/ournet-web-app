...
export function HoroscopeSignsLine({ lang, links, project, country }: HoroscopeSignsLineProps) {
    const host = project && project !== OurnetProjectName.HOROSCOPE ?
        (getSchema(OurnetProjectName.HOROSCOPE, country) + '//' + getHost(OurnetProjectName.HOROSCOPE, country))
        : '';

    return (<div className='o-pack o-pack--tiny'>
