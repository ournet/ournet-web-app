...
export function PageHeader(props: PageHeaderProps) {
    const { capital, capitalForecast, links, lang, country, project, locales } = props;
    const placeForecast = capital && capitalForecast
        ? (HeaderPlaceForecast({ links, lang, country, place: capital, forecast: capitalForecast }))
        : null;

    let logoUrl = resolveProjectLinkPrefix(project, OurnetProjectName.PORTAL, country) + links.portal.home({ ul: lang });
