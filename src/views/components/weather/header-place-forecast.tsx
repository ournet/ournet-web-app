...
export function HeaderPlaceForecast({ links, lang, country, place, forecast }: HeaderPlaceForecastProps) {
    ...
    return (
        <div className='c-cap'>
            ...
            <span className='c-cap__name'>
                <a href={getSchema(OurnetProjectName.WEATHER, country) + '//' + getHost(OurnetProjectName.WEATHER, country) + links.weather.place(place.id, { ul: lang })} title={name}>{name}</a>
